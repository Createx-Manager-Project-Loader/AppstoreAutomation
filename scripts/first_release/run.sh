...
log_step "Шаг 1/6: раскладка метаданных из листинга"
...
PY
  ...
  log_step "Шаг 3/6: скриншоты пропущены (SCREENSHOTS_ZIP_URL не задан)"
fi
...
log_info "Снимок состояния до заливки: $SNAPSHOT_PATH"
